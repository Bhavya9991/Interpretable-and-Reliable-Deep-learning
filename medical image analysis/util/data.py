...
def get_data(args: argparse.Namespace): 
    ...
    if args.dataset == 'CARS':
        return get_cars(True, './data/cars/cars_train', './data/cars/cars_train', './data/cars/cars_test')
    if args.dataset == 'XRAYS':
        return get_xrays(True, './data/xrays/xrays_train', './data/xrays/xrays_train', './data/xrays/xrays_test')
...
def get_xrays(augment: bool, train_dir:str, project_dir: str, test_dir:str, img_size = 224): 
    shape = (3, img_size, img_size)
    mean = (0.485, 0.456, 0.406)
    std = (0.229, 0.224, 0.225)
